...
Ture -> 0이 아닌 수, 문자, 데이터가 있는 리스트, 튜플, 집합(set), 딕셔너리 등
False -> 0, 비어있는 문자 "" , 데이터가 없는 리스트, 튜플, 집합, 딕셔너리 등
...
윤년이면서 2월인 경우랑 2월이 아닌 경우, 
윤년이 아니면서 2월인 경우랑 2월이 아닌 경우
2월이 아닌 경우 1,3,5,7,8,10,12월은 31일까지 그외 30일까지 
'''
...
# mm = [4, 6, 9, 11]
# if int(month) in m :
#     print('{} 년 {} 월 마지막 일은 {} 일 입니다.'.format(year, month, day[3]))
# elif int(month) in mm :
#     print('{} 년 {} 월 마지막 일은 {} 일 입니다.'.format(year, month, day[2]))
# elif (year%4 == 0 and year%100 != 0) or (year%400 == 0) :
#     print('{} 년 {} 월 마지막 일은 {} 일 입니다.'.format(year, month, day[1]))
# else :
#     print('{} 년 {} 월 마지막 일은 {} 일 입니다.'.format(year, month, day[0]))
#
# # 중첩 구문
# lst31 = [1, 3, 5, 7, 8, 10, 12]
# if month != 2 :
#     if month in lst31 :
#         print('{} 년 {} 월 마지막 일은 31 일 입니다.'.format(year, month))
#     else :
#         print('{} 년 {} 월 마지막 일은 30 일 입니다.'.format(year, month))
# else :
#     if (year%4 == 0 and year%100 != 0) or (year%400 == 0) :
#         print('{} 년 {} 월 마지막 일은 29 일 입니다.'.format(year, month))
#     else :
#         print('{} 년 {} 월 마지막 일은 28 일 입니다.'.format(year, month))
...
print('in - ' , 'nsjung' not in tmpDict.values()) # 키값이 아니라 밸류값을 가져오고 싶을 때 values
...
산술 > 관계 > 논리 순서로 우선순위를 갖고 적용됨
'''
# print('operator prioriy - ' , 3 + 12 > 7 + 3)
# print('operator prioriy - ' , 5 + 10 > 3 and not 7 + 3 == 10)
...
#     print('관리자 인증')
# if id02 == 'admin' and grad == 'platinum' :
#     print('최상위 관리자 인증')
...
# 변수 = '참' if (조건) else '거짓' if (조건) else '거짓'

# 주민번호 > 성별 > xxxxxx - 1xxxxxx 1,3 남자 , 2,4 여자
# 지역코드 00 ~ 08 : 서울지역
ssn = 'xxxxxx-107xxxx'
gender = ssn.split('-')[1]
result = '남자' if gender[0]=='1' or gender == 3 else '여자'
...
파이썬 반복문 : for ~, while 
 ...
 - for 변수 in <열거형> : <- 튜플 딕셔너리 리스트 블럭만드는 변수
    <loop body>
 - for ~
   else : 
 - for(초기식 : 조건식 : 증감식) {
